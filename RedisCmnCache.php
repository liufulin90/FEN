...
class RedisCmnCache {
	...
	/*
	 * // magic function public function __call($name,$arguments){ return
...
class Test{
	public function test1(){
		...
		/*
		 * $list = $redis->hget($cron_list,); var_dump($list);
		*/
		// */
		...
		/*
		 * $redis->lpush('test','1111'); $redis->lpush('test','2222');
		* $redis->lpush('test','3333'); $list = $redis->lrange('test',0,-1);
		* print_r($list); $lpop = $redis->lpop('test'); print_r($lpop); $lpop =
		* $redis->lpop('test'); print_r($lpop); $lpop = $redis->lpop('test');
		* print_r($lpop);
		*/
